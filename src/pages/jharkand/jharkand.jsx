...
import "../jharkand/jharkand.css"
import { useNavigate } from "react-router-dom";
import { useState , useEffect } from 'react';
const Jharkand = () =>{
  const navigate = useNavigate();      
    const JharkandPackages = data.packages.filter(pkg => pkg.skuID.includes('JHARKHAND'));
    const imgs = [
...
<h1> Explore Our Jharkand Packages
</h1>
<p>Discover the serene beaches and vibrant culture of Jharkand with our curated travel packages.
</p>
</div>
</div>
            <section className="all_packages">
                <h2>Choose packages from the differnt locations of Jharkand</h2>
                <div className="section_packages">
<div className="packages-container">
    {JharkandPackages.map(pkg => (
